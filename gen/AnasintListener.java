...
public interface AnasintListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link Anasint#tipo_instrucciones}.
	 * @param ctx the parse tree
	 */
	void enterTipo_instrucciones(Anasint.Tipo_instruccionesContext ctx);
	/**
	 * Exit a parse tree produced by {@link Anasint#tipo_instrucciones}.
	 * @param ctx the parse tree
	 */
	void exitTipo_instrucciones(Anasint.Tipo_instruccionesContext ctx);
	/**
	 * Enter a parse tree produced by {@link Anasint#estructuras}.
	 * @param ctx the parse tree
	 */
	void enterEstructuras(Anasint.EstructurasContext ctx);
	/**
	 * Exit a parse tree produced by {@link Anasint#estructuras}.
	 * @param ctx the parse tree
	 */
	void exitEstructuras(Anasint.EstructurasContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link Anasint#instruccion_asignacion}.
	 * @param ctx the parse tree
	 */
	void enterInstruccion_asignacion(Anasint.Instruccion_asignacionContext ctx);
	/**
	 * Exit a parse tree produced by {@link Anasint#instruccion_asignacion}.
	 * @param ctx the parse tree
	 */
	void exitInstruccion_asignacion(Anasint.Instruccion_asignacionContext ctx);
	/**
